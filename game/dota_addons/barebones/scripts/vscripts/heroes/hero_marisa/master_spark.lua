...
function masterSparkStart(keys)
	...
	startSpark(caster, keys.ability, "modifier_master_spark", "modifier_master_spark_slow", true, caster:GetForwardVector(), caster:FindAbilityByName("master_spark"), "particles/marisa/master_spark.vpcf")
